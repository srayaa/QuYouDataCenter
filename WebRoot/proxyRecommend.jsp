						...
						<!-- box-header well Start -->
							...
							<div class="box-content row">
								<div class="col-lg-7 col-md-12">
									...
									<form action="recommend.do" class="testform" method="post" onsubmit="return sumbit_sure()"
										>
										<input type="hidden" name="type" value="1"></input>
										<table class="table table-bordered table-striped responsive" style="position:absolute; top:30px; left:50px;">
											<tr>
												<td>名称：</td>
											...
											<tr>
												<td>联系电话：</td>
												<td><input type="text" value="" name="contactPhone" id="contactPhone"
													style="border:1px solid #b4b4b4;width:180px;" onblur="OnInput (event)" /></td>
											</tr>
											<tr>
												<td>推荐人：</td>
												<td><input type="number" value="" name="recommendPerson"
													style="border:1px solid #b4b4b4;width:180px" /></td>
											</tr>
											<tr>
												<td>限时房卡数量：</td>
